...
- **DefiTextMine_LLM.ipynb** -- autre approche utilisant un LLM (modèle Codestral de l'UM)
- **DefiTextMine_camembert.ipynb** -- une approche fondée sur CammemBERT
- **DefiTextMine_OpenAI.ipynb** -- ane approche utilisant ChatGPT
